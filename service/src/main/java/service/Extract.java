...
public class Extract {
  ...
  private int numPlaylists; //this might be irrelevant
  private Statement statement;
  private ArrayList<String> generatedPlaylists;
  ...
  public ArrayList<String> getGeneratedPlaylists() {
  ...
  public void createPlaylist(int uid) throws Exception {
    ...
    generatedPlaylists = new ArrayList<>();

    for (int i = 0; i < playlistsToCreate; i++) { //make sublists, youtube now has a maximum playlist size of 50
